...
- **CLAUDE.md** — AI si ho čte automaticky na začátku každé session, proto tam patří architektura, konvence a pravidla projektu
- **Memory system** — Claude Code má persistent memory (`~/.claude/projects/`), kam si ukládá poznámky napříč sessions
